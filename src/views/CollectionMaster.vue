...
const masterList = reactive([
  ...
  },
  {
    ...
    title: '清 肉形石',
    content:
      '此件肉形石乍看之下，像不像是一塊令人垂涎三尺、肥瘦相間的「東坡肉」？瑪瑙類礦物在大自然中，由於經過漫長歲月的累積，在不同的時間點，雜質影響乃至生成的顏色不同，呈現一層一層不同的色澤，製作此件肉形石的工匠，將原來質感豐富的石材加工琢磨，毛孔和肌理都逼真展現的作品。'
  },
  {
    id: '3',
    collectionId: 'U003',
  ...
  },
  {
    ...
    title: '東漢 玉辟邪',
    content:
      '玉琢成，昂首張口，似在低吼。跨步遊走，雙翼雖貼於身側，卻作蓄勢待發狀。頷下長鬚垂胸，長尾曳地，氣宇非凡。因曾經深沁熟盤，表面多有深淺褐斑。辟邪的胸前刻有御製詩。宮中還配有雙層紫檀木座，上層刻有「乾隆御玩」，下層刻有與辟邪胸前相同的御製詩，刻字的部分還嵌有銀絲。'
  },
  {
    id: '6',
    collectionId: 'U006',
    title: '西漢 玉蟬',
    content:
      '玉質，有褐斑，蟬形，蟬上刻線俐落是所謂「漢八刀」風格的刻法，漢代時此類玉蟬常作為「唅」，含於死人嘴內。蟬首有牛鼻穿，應為後世後所加，以作為綁繋穿繩的孔洞。'
  }
])
</script>
